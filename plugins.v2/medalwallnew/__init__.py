...
class MedalWallNew(_PluginBase):
    ...
    def __process_all_sites(self):
        ...
        try:
            ...
            # 保存所有勋章数据
            self.save_data('medals', all_buy_medals)
    ...
    def get_medal_data(self, site_id: str, site_bonus: float) -> List[Dict]:
        ...
        try:
            ...
            # 保存数据到缓存
            self.save_data(f'medals_{site_id}', medals)
    ...
    def get_page(self) -> list:
        ...
        try:
            ...
            for site_id in site_ids:
                medals = self.get_data(f'medals_{site_id}') or []
                unhas_medals = self.get_data(f'unhas_medals_{site_id}') or []
                has_medals = self.get_data(f'has_medals_{site_id}') or []
